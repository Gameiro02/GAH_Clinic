<script>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Adicionar listener para o botão de notificações
    const notificationButton = document.querySelector(
      ".btn.m-1.btn-ghost.text-secondary.flex.items-center"
    );
  ...
  <div class="navbar-start">
    <div class="dropdown">
      <div
        tabindex="0"
        role="button"
        class="btn btn-ghost text-secondary btn-circle"
      >
        <svg
  ...
  <div class="navbar-end flex">
    ...
    <div class="dropdown">
      <div
        tabindex="0"
        role="button"
        class="btn m-1 btn-ghost text-secondary flex items-center"
      >
        <div class="indicator">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      {#if showNotification}
        <ul
          class="dropdown-content z-[1] relative right-0 menu p-2 shadow bg-base-100 rounded-box w-52"
        >
          <li class="menu-title text-primary text-center justify-center">
            Consultas por Pagar
          </li>
