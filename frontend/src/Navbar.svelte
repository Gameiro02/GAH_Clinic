<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    themeToggle.addEventListener('change', function() {
      if (this.checked) {
        // When checked, use the "synthwave" theme
        document.documentElement.setAttribute('data-theme', 'night');
      } else {
        // When unchecked, revert to the "light" theme
...
<div class="navbar bg-base-100">
  <div class="navbar-start">
    <div class="dropdown">
      <div tabindex="0" role="button" class="btn btn-ghost text-secondary btn-circle">
  ...
  <div class="navbar-end flex space-x-4">
    ...
    <button class="btn btn-ghost text-secondary btn-circle">
      <div class="indicator">
